...
const SubPanel = ({ title, icon: Icon, color, onClose, onSave, children }) => {
  return createPortal(
    ...
    >
      ...
      {/* Content */}
      <div
        className="relative z-10 w-[320px] mt-20 rounded-xl border border-gray-200 dark:border-gray-700
                   bg-white dark:bg-[#1a1a2e] shadow-2xl shadow-black/10 dark:shadow-black/40
                   animate-in fade-in zoom-in-95 overflow-hidden max-h-[85vh] flex flex-col"
      ...
      >
        ...
        {/* Body */}
        <div className="px-3 py-3 space-y-3 max-h-[420px] overflow-y-auto custom-scrollbar">
          {children}
        </div>
